...
const itineraryData: DayPanel[] = [
  ...
  },
  {
    ...
    locations: [
      ...
      { time: "14:30", name: "TRAVELER'S FACTORY", description: "TN旅人笔记本全球旗舰店，藏在隐秘巷子里的复古文具天堂。", isKeyPlace: false, imageUrl: "/travelers_factory.jpg" },
  ...
  },
  {
    ...
    locations: [
      ...
      { time: "18:30", name: "神乐坂 虎白", description: "神乐坂的米其林三星，享受极具颠覆感与高级质感的顶级怀石料理。", isKeyPlace: true, audioLink: "https://www.xiaoyuzhoufm.com/episode/656ab35e381662fb52ab27e3" }
    ]
  },
  {
  ...
  },
  {
    ...
    locations: [
      ...
      { time: "19:00", name: "VelRosier", description: "米其林二星，体验极具颠覆性的现代中华/法式融合料理。", isKeyPlace: true, audioLink: "https://www.xiaoyuzhoufm.com/episode/656ab35e381662fb52ab27e3", imageUrl: "https://scontent-nrt6-1.cdninstagram.com/v/t51.82787-15/620919881_18090693284099351_3194353027367164795_n.jpg?stp=dst-jpg_e35_tt6&_nc_cat=107&ig_cache_key=MjU3OTM0Mzc1OTc0MTUyMTMzNA%3D%3D.3-ccb7-5&ccb=7-5&_nc_sid=58cdad&efg=eyJ2ZW5jb2RlX3RhZyI6InhwaWRzLjM2MHgzNjAuc2RyLkMzIn0%3D&_nc_ohc=1bcWITXy8mIQ7kNvwF0vFeP&_nc_oc=AdpM4l_ODgJDK1r9T06kaN8TeDEzYC_StaU2wUVSxRjLkiGY6Op8a_7csq_RKKoxAwxqVUPeR3kMzmkvFq4vN7vY&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=scontent-nrt6-1.cdninstagram.com&_nc_gid=6Hrs_prYBQmp26RvJ2XCWg&_nc_ss=7a22e&oh=00_Af3FORIuFI5tC228R4a7u3A9C9U_CNpPDt2b9raV3PVeWQ&oe=69EFD1CC" }
    ]
  },
  {
    ...
    locations: [
      ...
      { time: "18:30", name: "cenci", description: "米其林一星，平安神宫旁红砖餐厅内的意式料理创新。", isKeyPlace: true, audioLink: "https://www.xiaoyuzhoufm.com/episode/650b21dfb5c00e62057d1eb2", imageUrl: "https://cenci-kyoto.com/wp/wp-content/uploads/2015/01/16_cenci_web_ol_52.jpg", imageLink: "https://cenci-kyoto.com/" }
    ]
  },
  {
  ...
  return (
    <div className="h-screen w-full bg-[#F2F0ED] text-[#333333] font-serif overflow-hidden flex flex-col">
      ...
      <main className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        <nav className="w-full lg:w-[320px] lg:border-r border-[#DCD9D4] flex flex-col bg-[#FAF9F7] shrink-0 overflow-y-auto lg:overflow-visible h-[40vh] lg:h-full border-b lg:border-b-0">
          ...
          <div className="flex-1 overflow-y-auto font-sans text-sm">
        ...
        <section className="flex-1 bg-white p-6 md:p-12 lg:p-16 flex flex-col overflow-y-auto [&::-webkit-scrollbar]:hidden relative">
          <AnimatePresence mode="wait">
            <motion.div 
              ...
              className="max-w-2xl mx-auto w-full origin-top"
            >
              <div className="mb-16">
                <motion.div 
                  initial={{ width: 0 }}
                ...
                <p className="mt-8 font-serif text-base md:text-lg text-[#8C867A] leading-relaxed max-w-xl italic">
                  {activeDayData.title}
                </p>
              </div>
              ...
              <div className="space-y-16">
                {activeDayData.locations.map((loc, idx) => (
                  <motion.div 
                    ...
                    key={idx} 
                    className="flex flex-col sm:flex-row gap-8 md:gap-12 group"
                  >
                     {!loc.hideImage && (
